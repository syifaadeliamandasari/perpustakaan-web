...
<head>
    ...
    <title>{{ $title . ' - Perpustakaan Admin' ?? 'Perpustakaan Admin' }}</title>
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">{{ $title ?? 'Perpustakaan' }}</h1>
                    </div>
            ...
            <footer class="sticky-footer bg-white">
                <div class="container my-auto">
                    <div class="copyright text-center my-auto">
                        <span>Di buat ongleh <span style="color: white; background-color: rgb(77, 163, 65);border-radius: 4px; padding: 2px; display: inline;">Kelompok 6 klo gk salah</span>
